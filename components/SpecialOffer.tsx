...
const SpecialOffer = () => {
  return (
    <section className="bg-black px-2 py-8 text-white mt-20 mb-3 padding-x max-w-[1440px] mx-auto flex justify-between items-center max-lg:flex-col gap-10 w-full">
      <div className="flex flex-1 flex-col ">
        ...
        <p className="text-xl leading-8 mt-6 mb-2">
          Discover the exceptional value of the 2023 Toyota RAV4 XLE. Act now to
          take advantage of this exclusive offer and drive home your new RAV4
          today! (
